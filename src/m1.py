...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.colors = colors
        self.origin = self.circle.fill_color
        self.index = 0
    ...
    def swallow(self, other_circle_changer):
        ...
        acenter = other_circle_changer.circle.center
        center1 = center.halfway_to(acenter)
        radius1 = (self.get_distance_from(acenter)) / 2
        colors1 = self.colors + other_circle_changer.colors
        circle1 = CircleChanger(center1.x, center1.y, radius1, 'red', colors1)
        return circle1
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.origin
